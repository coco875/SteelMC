...
impl SimdNoiseChunk {
    ...
    pub fn new(chunk_min_block_x: i32, chunk_min_block_z: i32) -> Self {
        let cell_width = OverworldNoiseSettings::CELL_WIDTH;
        ...
        let interp_count = SimdOverworldNoises::interpolated_count();
        assert!(
    ...
    pub fn fill<F>(
        ...
        F: FnMut(usize, i32, usize, f64, &[f64], &mut SimdOverworldColumnCache),
    {
        let cell_width = OverworldNoiseSettings::CELL_WIDTH;
        let cell_height = OverworldNoiseSettings::CELL_HEIGHT;
