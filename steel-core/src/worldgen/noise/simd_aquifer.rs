...
use crate::worldgen::noise::aquifer::AquiferResult;
...
impl SimdAquifer {
    ...
    pub fn new(
        ...
        mut cache: SimdOverworldColumnCache,
    ) -> Self {
        const AQUIFER_HASH: NameHash = NameHash::new("minecraft:aquifer");

        let sea_level = OverworldNoiseSettings::SEA_LEVEL;
        ...
        let default_fluid_id = OverworldNoiseSettings::default_fluid_id();
        ...
        if !OverworldNoiseSettings::AQUIFERS_ENABLED {
            return Self {
    ...
    fn max_preliminary_surface_level(
        noises: &SimdOverworldNoises,
        cache: &mut SimdOverworldColumnCache,
        min_x: i32,
        min_z: i32,
        max_x: i32,
        max_z: i32,
    ...
    fn get_aquifer_status(&mut self, index: usize, noises: &SimdOverworldNoises) -> FluidStatus {
...
pub(crate) fn simd_preliminary_surface_level(
    noises: &SimdOverworldNoises,
    cache: &mut SimdOverworldColumnCache,
    x: i32,
    z: i32,
